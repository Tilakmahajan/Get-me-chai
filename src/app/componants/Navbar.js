        ...
        <nav className='bg-gradient-to-r from-sky-500 to-indigo-500 text-black flex justify-between items-center px-4 md:h-12 flex-col md:flex-row'>
            ...
            <div className="buttons mt-2 relative">
                {session && <>
                    ...
                    }, 100)} }     data-dropdown-toggle="dropdown" className="text-white mx-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">{session.user.email} <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                    </svg>
                    </button>

                    <div id="dropdown"   className={` z-10 ${showdropdown ? "" : "hidden"} left-[80px] absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 `}>
